...
<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a href="settings.php" class="group bg-white dark:bg-slate-800 p-5 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 hover:border-brand-orange hover:ring-1 hover:ring-brand-orange transition cursor-pointer flex flex-col items-center text-center">
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Geral</p>
        </a>

        <a href="security.php" class="group bg-white dark:bg-slate-800 p-5 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 hover:border-green-500 hover:ring-1 hover:ring-green-500 transition cursor-pointer flex flex-col items-center text-center">
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Configurar 2FA</p>
        </a>
